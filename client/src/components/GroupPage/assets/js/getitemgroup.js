...
function getCmGroup() {
  $.ajax({
    ...
    getcm = data.data;
    console.log(getcm);
    if(getcm.post.content != null) {
        
      $(".post-item-group").prepend(
        `
        <div class="content-main bg-7c mb-3 " key="${getcm.post._id}">
                                        <div class="author">
                                            ...
                                            <div class="author-status">
                                                <span>${getcm.post.content}</span>
                                            </div>
                                        </div>

                                        <div class="reaction-comment d-flex justify-content-between">
                                            <div class="reaction" key="${getcm.post._id}">
                                                <span>
                                        ...
                                        <div class="post-comment-main">
                                            ...
                                            <div class=" row d-flex align-items-center post-comment-item">
                                                ...
                                                <div class="col-9 post-main">
                                                    <input type="text"
                                                        class="form-control gPgfXu comment-post${getcm.post._id} comment__form">
                                                </div>
                                                <div class="col-2 p-0">
